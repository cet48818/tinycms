        ...
        <div class="col-lg-6">
          ...
          <form class="form-horizontal" id="singcms-form">
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" name="name" value="<?php echo ($position["name"]); ?>" class="form-control" id="inputname" placeholder="请填写标题">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" class="form-control" name="description" value="<?php echo ($position["description"]); ?>" id="inputPassword3" placeholder="描述">
              </div>
            </div>
            <!-- 主键ID -->
