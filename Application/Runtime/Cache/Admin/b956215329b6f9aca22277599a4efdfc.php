        ...
        <div class="row">
            <form action="/admin.php" method="get">
                <div class="input-group container-fluid">
                    ...
                    <select id="menu-select" class="form-control" name="type">
                        <option value=''>请选择类型</option>
                        <option value="2" <?php if($type == 2): ?>selected<?php endif; ?>>全部菜单</option>
                        <option value="1" <?php if($type == 1): ?>selected<?php endif; ?>>后端菜单</option>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover singcms-table">
                        ...
                        <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($menu["menu_id"]); ?>"></span>    <a href="javascript:void(0)" attr-id="<?php echo ($menu["menu_id"]); ?>" id="singcms-delete"  attr-a="menu" attr-message="删除"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span></a></td>
...
<script>
    ...
    var SCOPE = {
        'index_url': '/admin.php?c=menu&a=index',
...
<!-- footer里有加载common.js, 所以公共js文件可以放到common.js里 -->