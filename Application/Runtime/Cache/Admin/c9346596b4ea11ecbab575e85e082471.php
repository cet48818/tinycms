              ...
              <div class="col-sm-5">
                <select class="form-control" name="title_font_color">
                  <option value="">==请选择颜色==</option>
                    <?php if(is_array($titleFontColor)): foreach($titleFontColor as $key=>$color): ?><option value="<?php echo ($key); ?>" <?php if($key == $news['title_font_color'] ): ?>selected<?php endif; ?>><?php echo ($color); ?></option><?php endforeach; endif; ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="catid">
                  <?php if(is_array($webSiteMenu)): foreach($webSiteMenu as $key=>$siteNav): ?><option value="<?php echo ($siteNav["menu_id"]); ?>" <?php if($siteNav["menu_id"] == $news['catid'] ): ?>selected<?php endif; ?>><?php echo ($siteNav["name"]); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <select class="form-control" name="copyfrom">
                    <?php if(is_array($copyfrom)): foreach($copyfrom as $key=>$cfrom): ?><option value="<?php echo ($key); ?>" <?php if($key == $news['copyfrom'] ): ?>selected<?php endif; ?>><?php echo ($cfrom); ?></option><?php endforeach; endif; ?>
                </select>
              </div>
            </div>
