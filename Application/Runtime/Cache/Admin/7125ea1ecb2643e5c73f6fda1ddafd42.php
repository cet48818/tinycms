			...
			<div class="col-lg-6">
				...
				<form class="form-horizontal" id="singcms-form">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select class="form-control" name="position_id">
                                <?php if(is_array($positions)): foreach($positions as $key=>$position): ?><option value="<?php echo ($position["id"]); ?>" <?php if($position['id'] == $vo['position_id'] ): ?>selected<?php endif; ?>><?php echo ($position["name"]); ?></option><?php endforeach; endif; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="url" id="inputPassword3" placeholder="请填写url地址" value="<?php echo ($vo["url"]); ?>">
						</div>
					</div>
					<div class="form-group">
