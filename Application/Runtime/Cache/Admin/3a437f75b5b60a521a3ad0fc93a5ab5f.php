    ...
    <div class="container-fluid" >
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            <li>
              <i class="fa fa-dashboard"></i>  <a href="/admin.php?c=content">推荐位管理</a>
            </li>
          </ol>
        </div>
      </div>
            ...
            <form id="singcms-listorder">
              <table class="table table-bordered table-hover singcms-table">
                ...
                <?php if(is_array($positions)): $i = 0; $__LIST__ = $positions;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$positions): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                      <?php echo (date("Y-m-d H:i",$positions["create_time"])); ?>
                    </td>
                    ...
                    <td><span class="sing_cursor glyphicon glyphicon-edit" aria-hidden="true" id="singcms-edit" attr-id="<?php echo ($positions["id"]); ?>" ></span>
...
<script>
  var SCOPE = {
    ...
    'sing_position_view_url' : '/index.php?c=view',
